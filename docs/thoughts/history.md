...
<div class="site-history">
  ...
  <section class="site-history__entry">
    ...
    <div class="site-history__description">
      <p class="site-history__placeholder">首页搓了两个比较满意的动态动画</p>
  ...
  <section class="site-history__entry">
    ...
    <div class="site-history__description">
      <p class="site-history__placeholder">首页用html加入了负一层（这一步用ds搞了好久没搞定，后来用codex一下就解决了...）</p>
...
<dialog class="history-lightbox" data-history-lightbox aria-label="图片预览">
  ...
  <img class="history-lightbox__image" data-history-lightbox-image alt="">
</dialog>

<script src="../../js/history-lightbox.js"></script>
